...
image1=pygame.image.load("Pro Games/Birthday/birthday1.jpg")
image1=pygame.transform.scale(image1,(WIDTH,HEIGHT))

image2=pygame.image.load("Pro Games/Birthday/birthday2.jpg")
image2=pygame.transform.scale(image2,(WIDTH,HEIGHT))


image3=pygame.image.load("Pro Games/Birthday/birthday3.jpg")
image3=pygame.transform.scale(image3,(WIDTH,HEIGHT))

image4=pygame.image.load("Pro Games/Birthday/birthday4.jpg")
image4=pygame.transform.scale(image4,(WIDTH,HEIGHT))

image5=pygame.image.load("Pro Games/Birthday/birthday5.jpg")
...
while gameload:
    ...
    t1=font.render("Happy Birthday", True,"black")
    screen.blit(image1,(0,0))
    screen.blit(t1,(200,200))
    pygame.display.update()
    time.sleep(2)

    t2=font.render("Wish you a bright future ahead",True,"black")
    ...
    t4=font.render("One year older again",True,"black")
    ...
    t6=font.render( "time during your party",True,"black")
