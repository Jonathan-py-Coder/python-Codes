...
anwsear_box1.move_ip(20,270)
anwsear_box2.move_ip(370,270)
anwsear_box3.move_ip(20,450)
anwsear_box4.move_ip(370,450)
...
def draw():
    ...
    screen.draw.filled_rect(marquee_box,"violet")
    ...
    screen.draw.textbox(marquee_message,marquee_box,color="green")
